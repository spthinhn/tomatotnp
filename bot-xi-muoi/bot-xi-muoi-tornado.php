					...
					<div class="container heading-standar">
						<div class="page-breadcrumb">
							<ul class="breadcrumb">
								...
								<li><span><a href="/bot-xi-muoi.php" class="san-pham"><span>Bột xí muội</span></a></span></li>
									...
									<div class="container">
										<div class="row summary-container">
															...
															<div class="caroufredsel-wrap">
																<ul class="caroufredsel-items">
																	<li class="caroufredsel-item">
																		<div class="thumb">
																			<a href="/images/bot-xi-muoi/bxm01.jpg" data-rel="magnific-popup-verticalfit" title="Product-detail">
																				<img width="100%" src="/images/bot-xi-muoi/bxm01.jpg" />
																			</a>
																		</div>
																	</li>
																	<li class="caroufredsel-item">
																		<div class="thumb">
																			<a href="/images/bot-xi-muoi/bxm02.jpg" data-rel="magnific-popup-verticalfit" title="Product-detail">
																				<img width="100%" src="/images/bot-xi-muoi/bxm02.jpg" />
																			</a>
																		</div>
																	</li>
																</ul>
											...
											<div class="col-md-4 col-sm-6 entry-summary">
												<div class="summary">
													<h1 class="product_title entry-title">Bột xí muội Volcano (gói 1kg)</h1>
													<p class="price"><span class="amount"><strong>Giá: </strong>220,000 VNĐ </span></p>
													<div class="product-excerpt">
														<p>
															Bột xí muội Volcano được sản xuất tại Việt Nam với nguồn nguyên liệu được lựa chọn và kiểm tra chặt chẽ.
														</p>
													</div>
												</div> 
											</div>
														...
														<div class="panel panel-default">
															...
															<div id="collapseGioiThieu" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingGioiThieu">
																<div class="panel-body">
																	...
																	<p>
																		Bột có dạng mịn, vị xí muội mặn ngọt chua, màu nâu nhạt và thơm nồng xí muội.
																	</p>
																	<p>
																		Quy cách đóng gói: 
																		<ul>
														...
														<div class="panel panel-default">
															...
															<div id="collapseHDSD" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingHDSD">
																<div class="panel-body">
																	...
																	<p>
																		Dùng làm gia vị cho khoai lang lắc, khoai tây, các loại trái cây: xoài, thơm, cóc, ổi.
																	</p>
																</div>
															</div>
														</div>
